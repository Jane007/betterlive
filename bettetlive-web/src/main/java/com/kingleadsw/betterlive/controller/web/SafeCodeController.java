 ...
 *
 */
@RequestMapping("/admin/safecode")
@Controller
public class SafeCodeController  extends AbstractWebController {
    ...
    public void getSafeCode(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getSession(true).setAttribute("safecode", randomString);
        
        int width = 114; //验证码图片宽度
        int height = 43; //验证码图片高度
        ...
        g.setColor(reverse);
        g.drawString(randomString, 30, 26);
