...
import com.kingleadsw.betterlive.util.wx.MyX509TrustManager;
...
public class HttpClientTool {
    ...
    public static String get(String url){
        ...
        try {
        	...
        	logger.error("HttpClientTool/get --error", e);
        }
        return result;
    }
	...
	public static JSONObject httpsRequest(String requestUrl, String requestMethod, String outputStr) {
		...
		try {
			...
			logger.error("HttpClientTool/httpsRequest --error", ce);
		} catch (Exception e) {
			logger.error("HttpClientTool/httpsRequest --error", e);
		}
		return jsonObject;
	}
	...
	//将notify到本服务器的请求参数放入map
	public static Map<String, String> requestAli2Map(HttpServletRequest request){
