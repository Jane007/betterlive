	...
	$.ajax({                                       
		...
		success:function(data){
			...
			for (var continueIndex in list) {
				...
				var replyerName = "";
				if(commentVo.replyerName != null && commentVo.replyerName != "" && commentVo.replyerId != parentCustId){
				...
				var showHtml = '<li>'
							  +'	<div class="litop" onclick="toReply('+ commentVo.commentId +',\''+ commentVo.customerVo.nickname +'\',' + commentVo.customerVo.customer_id + ')">'
							  +'		<div class="topimg">'
							  ...
							  +'	</div>'
							  +'	<div class="libottom">'
							  +'		<p onclick="toReply('+ commentVo.commentId +',\''+ commentVo.customerVo.nickname +'\',' + commentVo.customerVo.customer_id + ')">' + replyerName + commentVo.content +'</p>'
							  +'		<div class="uplike">'
...
function toReply(commentId, nickName, customerId){
