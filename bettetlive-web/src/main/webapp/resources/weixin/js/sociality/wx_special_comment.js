    ...
    function go1(){
		...
		if(tabType == 2){
			window.location.href=mainServer+"/weixin/special/toVideoCommentDetail?specialId="+specialId}+"&commentId="+commentId+"&backUrl="+backUrl;
		}else if(tabType == 1){
			window.location.href=mainServer+"/weixin/discovery/toTorialComment?specialId="+specialId;
		}else if(tabType == 0){
			window.location.href=mainServer+"/weixin/specialarticle/toSpecialArticle?articleId="+specialId;
		}
    }
  ...
  //提交评价
	...
	$(function(){
		...
		if(tabType == 2){
			url=mainServer+"/weixin/special/toVideoCommentDetail?specialId="+specialId}+"&commentId="+commentId+"&backUrl="+backUrl;
		}else if(tabType == 1){
			url=mainServer+"/weixin/discovery/toTorialComment?specialId="+specialId;
		}else if(tabType == 0){
			url=mainServer+"/weixin/specialarticle/toSpecialArticle?articleId="+specialId;
		}
		var bool=false;  
        setTimeout(function(){  
              bool=true;  
