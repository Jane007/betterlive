...
function exportExcel() {
	...
	location.href = mainServer
			+ "/admin/orderanaly/exportExcelOtherPro?startTime=" + startTime
			+ "&endTime=" + endTime + "&productName=" + productName;
}
	...
	createGrid : function(grId) {
		return $('#' + grId)
				.datagrid(
						{
							url : mainServer
									+ '/admin/orderanaly/otherQueryProductSales',
							rownumbers : true,
							singleSelect : false,
							pagination : true,
							autoRowHeight : true,
...
function clickDetailedEntity(value) {
	...
	var url = mainServer + "/admin/otherorder/findList?productCode=" + value
