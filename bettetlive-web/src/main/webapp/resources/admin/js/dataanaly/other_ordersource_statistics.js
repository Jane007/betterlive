...
function exportExcel() {
	...
	location.href = mainServer
			+ "/admin/orderanaly/exportExcelByOtherOrderSource?startTime="
	...
	createGrid : function(grId) {
		return $('#' + grId)
				.datagrid(
						{
							url : mainServer
									+ '/admin/orderanaly/otherQueryTotalByOrderSource',
							rownumbers : true,
							singleSelect : false,
							pagination : true,
							autoRowHeight : true,
...
function clickDetailedEntity(value) {
	...
	var url = mainServer + "/admin/otherorder/findList?orderSource=" + value
