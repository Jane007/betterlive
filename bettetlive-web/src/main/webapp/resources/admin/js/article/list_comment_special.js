...
function searchComment() {
	$('#StoreGrid').datagrid('load', {
		"articleFrom" : $('#articleFrom').combobox('getValue'),
	...
	createGrid : function(grId) {
		return $('#' + grId)
				.datagrid(
						{
							url : mainServer
									+ '/admin/specialcomment/queryArticleCommentJson?parentFlag=1&articleFrom=0&status=2',
							rownumbers : true,
							singleSelect : false,
							pagination : true,
							autoRowHeight : true,
...
//									},
									...
									},
									{
										...
										width : 80,
										formatter : function(value, rec) {// 使用formatter格式化刷子
											return '<a href="' + mainServer + '/admin/specialcomment/findIdList?id=' + rec.commentId + '" >查看全部回复</a>'
...
function submitReplyForm() {
	...
	var checkType = $('#articleFrom').combobox('getValue');
