	...
	$('#specialform').form(
			'submit',
			{
				...
				onSubmit : function() {
					...
					var specialTitle = $("#articleTitle").val(); // 专题文章标题
...
//					var homeCover = $("#filebox_file_id_1").val();
//					if (homeCover == null || homeCover == "") {
//						alert("请上传主页列表封面图");
//						return false;
//					}

					$("#articleCover").val(buffer.toString());
					var specialUrl2 = $("#articleCover").val(); // 专题封面
