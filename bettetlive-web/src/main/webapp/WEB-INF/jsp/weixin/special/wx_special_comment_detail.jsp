...
<html>
	<head>
    	...
    	<link rel="stylesheet" href="${resourcepath}/weixin/css/discuss.css?t=201801221544">
		...
		<script type="text/javascript">
			...
			var link = '${mainserver}/weixin/special/toVideoCommentDetail?specialId=${commentVo.specialId}&commentId=${commentVo.commentId}';
			var imgUrl = "${resourcepath}/weixin/img/huihuologo.png";
			var backUrl="${backUrl}";
			if(backUrl==''){
				backUrl = "${mainserver}/weixin/discovery/toTorialComment?specialId=${commentVo.specialId}";
			}
    ...
    <script src="${resourcepath}/weixin/js/special/wx_special_comment.js"></script>
