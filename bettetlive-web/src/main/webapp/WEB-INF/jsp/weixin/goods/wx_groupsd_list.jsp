...
<body id="tbody"> 
	...
	<div id="groupsGoods" style="top:0rem;"></div>
	...
	<script type="text/javascript">
		...
		var link = '${mainserver}/weixin/toGroupGoods' + ordSource;
	...
	<script src="${resourcepath}/weixin/js/goods/wx_groupsd_list.js?t=201802061147"></script> 
