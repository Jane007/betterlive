...
<html>
	<head>
    	...
    	<link rel="stylesheet" href="${resourcepath}/weixin/css/common.css?t=201801061337" />
    	<link rel="stylesheet" href="${resourcepath}/weixin/css/goodLists.css" />
    	<script src="${resourcepath}/weixin/js/rem.js"></script>
    	<script type="text/javascript" src="http://res.wx.qq.com/open/js/jweixin-1.0.0.js"></script>
    	<script type="text/javascript" src="${resourcepath}/admin/js/application.js"></script>
		<title>挥货-	<c:if test="${extensionType == 1}">每周新品</c:if><c:if test="${extensionType == 2}">人气推荐</c:if></title>
		<script type="text/javascript">
    		...
    		var link = '${mainserver}/weixin/product/productList?extensionType=${extensionType}';
	...
	<body>
		<div class="initloading"></div>
		 <div id="showContent0" class="myordercent" style="margin-top:0rem;">
		 		<div class="evaluateBox tuijianboxs">
					 ...
					 <div id="showProduct0" class="tuijianbox">
					 </div>		
	 ...
	 <input type="hidden" id="extensionType" value="${extensionType}">
	...
	<script src="${resourcepath}/weixin/js/goods/wx_product_list.js?t=201803300933"></script> 
