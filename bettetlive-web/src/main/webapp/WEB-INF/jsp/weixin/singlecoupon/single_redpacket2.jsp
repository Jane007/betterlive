...
<html>
	<head>
    	...
    	<link rel="stylesheet" href="${resourcepath}/weixin/css/common2.css" />
  		<link rel="stylesheet" href="${resourcepath}/weixin/css/new-getRedpacket.css" />
	...
	<body>
		<div class="container">
			<div class="headbg">
				<img src="${resourcepath}/weixin/img/songhongbao.jpg" alt="" />
			</div>
			<div id="mainBoxShow" class="mainBox">
				...
				<div class="useBox">
					...
					<div class="redpacketHit">
						<span class="rule"><i></i>使用规则</span><em class="put">红包已放入您的账号，<a href="${mainserver}/weixin/customercoupon/mySingleCoupon">点击查看</a></em>
					</div>
				    </div>
					  <div class="oldUser">
						<div class="coupon">
	...
	$(function(){
		...
		if(theUrl.indexOf("source")!=-1){
			orderSource = getQueryString("source");
...
// 								location.href='${mainserver}/weixin/product/towxgoodsdetails?productId='+productId;
							...
							$("#mainBoxShow").addClass("mainBox1");
					  		...
					  		if(data.msg == "您已经领取过了"){
					  			$(".getBox").hide();
					  			$('.now-use').on('click',function(){
									location.href='${mainserver}/weixin/product/towxgoodsdetails?productId='+productId+"&orderSource="+orderSource;
								});	
