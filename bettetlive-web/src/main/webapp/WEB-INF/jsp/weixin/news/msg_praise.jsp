...
<head>
	...
	<link rel="stylesheet" href="${resourcepath}/weixin/css/news/msg_praise.css?t=201801171040" />
...
<body>
	 ...
	 <div id="laout">
	 	<div class="header-wrap">
			<div class="header">
				...
				<div class="tab">
					<a href="${mainserver}/weixin/message/toMessageList?msgType=4">评论<span id="cmmCountId"></span></a>
					<a href="javascript:void(0);" class="on">点赞<span id="praiseCountId"></span></a>
				</div>
			</div>
		</div>
	 ...
	 <script src="${resourcepath}/weixin/js/common.js"></script> 
 	 <script type="text/javascript" src="${resourcepath}/weixin/js/news/msg_praise.js?t=201802261710"></script>
