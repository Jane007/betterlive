...
<head>
	...
	<script type="text/javascript" src="http://res.wx.qq.com/open/js/jweixin-1.0.0.js"></script>
 	<script type="text/javascript">
		...
		var link = '${mainserver}/weixin/message/toMessageList?msgType=0';
...
<body style="background: #eee;">
	...
	<div class="hdbox">
	 ...
	 <script type="text/javascript" src="${resourcepath}/weixin/js/news/Systemmessage.js?t=201802271511"></script>
