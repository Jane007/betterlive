...
<head>
	...
	<meta name="keywords" content="挥货,我的消息，交易消息" /> 
	...
	<script type="text/javascript">
		...
		var link = '${mainserver}/weixin/message/toMessageList?msgType=3';
...
<body style="background: #eee;">
	...
	<div class="loadingmore">   
	 ...
	 <script type="text/javascript" src="${resourcepath}/weixin/js/news/Transactionmessage.js?t=201802271511"></script>
