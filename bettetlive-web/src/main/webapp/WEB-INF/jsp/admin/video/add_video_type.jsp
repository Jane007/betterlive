...
<html>
	...
	<body>
		<div class="container">
			<div class="content">
				<div class="easyui-tabs1" style="width:100%;">
			      <div title="添加视频分类" data-options="closable:false" class="basic-info">
		...
		<script type="text/javascript" src="${resourcepath}/admin/js/video/add_video_type.js"></script>
	</body>
</html>