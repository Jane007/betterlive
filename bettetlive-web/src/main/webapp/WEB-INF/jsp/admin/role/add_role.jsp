...
<body>
							...
							<tbody>
								<tr>
									...
									<td class="kv-content" colspan="3">
										<input id="roleName" name="roleName" class="textbox" style="height:35px;margin:0 0;width:220px;" maxlength="100" >
								...
								<tr>
									...
									<td class="kv-content" colspan="3">
										<input id="roleType" name="roleType" disabled="disabled" class="textbox" style="height:35px;margin:0 0;width:220px;" maxlength="100" >
	...
	<script type="text/javascript" src="${resourcepath}/admin/js/role/add_role.js"></script>
</body>
</html>