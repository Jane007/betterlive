...
<body>
	<div class="container">
		<div class="content">
			<div class="easyui-tabs1" style="width: 100%;">
				<div title="修改角色信息" data-options="closable:false" class="basic-info">
					<div class="column">
					...
					<form id="specialform" name="specialform"
						...
						<table class="kv-table">
							<tbody>
								<tr>
									<td class="kv-label">角色名称:&nbsp;<font color="red">*</font></td>
									<td class="kv-content" colspan="3">
										<input type="hidden" value="${role.roleId }" id ="roleId" name="roleId"/>
										<input id="roleName" name="roleName" value="${role.roleName }" class="textbox" style="height:35px;margin:0 0;width:220px;" maxlength="100" >
									 	<span id="roleName_msg" style="color: red;"></span>
									</td>
								</tr>
								<tr>
									<td class="kv-label">角色类型:&nbsp;</td>
									<td class="kv-content" colspan="3">
										<input id="roleTy" name="roleTy" disabled="disabled" value="${role.roleType }" class="textbox" style="height:35px;margin:0 0;width:220px;" maxlength="100" >
									 	<input type="hidden" value="${role.roleType }" id ="roleType" name="roleType"/>
									 	<span id="roleType_msg" style="color: red;">系统自动分配</span>
									</td>
								</tr>
							</tbody>
						</table>
	...
	<script type="text/javascript" src="${resourcepath}/admin/js/role/update_role.js"></script>
</body>
</html>