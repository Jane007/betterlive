...
<html>
	...
	<body>
		<div class="container">
			<div class="content">
				<div class="easyui-tabs1" style="width:100%;">
			      <div title="修改预售商品信息" data-options="closable:false" class="basic-info">
			      		...
			      		<form id="productform"  action="${mainServer}/admin/preproduct/addPreProduct"  method="post" enctype="multipart/form-data">
					      	<input type="hidden" name="preId" id="preId" value="${preProduct.preId }"/>
					      	<input type="hidden" name="discountPrice" id="discountPrice" value="${preProduct.discountPrice }" />
					      	<input type="hidden" name="productId"  value="${preProduct.productId }" />
					      	<table class="kv-table">
								<tbody>
									<tr>
										<td class="kv-label">预售标题&nbsp;<font color="red">*</font></td>
										<td class="kv-content" colspan="2">
											<input class="textbox" type="text" name="preName" id="preName" value="${preProduct.preName }" style="height:35px;margin:0 0;width:220px;" maxlength="100"/>
											<span id="Name_msg" style="color: red;"></span>
										</td>
										<td class="kv-label">产品名称&nbsp;<font color="red">*</font></td>
										<td class="kv-content" colspan="2">
											
											<select id="productId" style="height:35px;margin:0 0;width:220px;" disabled="disabled">
												<option value="" selected="selected">请选择</option>
												<c:forEach items="${products }" var="product">
													<option value="${product.product_id }" <c:if test="${preProduct.productId==product.product_id }">selected="selected"</c:if>>${product.product_name }</option>
												</c:forEach>
											</select>
									...
									<tr>
										...
										<td class="kv-content" colspan="2">
											<input class="easyui-datetimebox" type="text" name="raiseStart" id="raiseStart" value="${preProduct.raiseStart }"   style="height:35px;margin:0 0;width:220px;"/>
											<span id="Start_msg" style="color: red;"></span>
										</td>
										
										<td class="kv-label">预售结束时间&nbsp;<font color="red">*</font></td>
										<td class="kv-content" colspan="2">
											<input class="easyui-datetimebox" type="text" name="raiseEnd" id="raiseEnd" value="${preProduct.raiseEnd }"   style="height:35px;margin:0 0;width:220px;"/>
									...
									<tr>
										...
										<td class="kv-content" colspan="2">
											<input class="easyui-numberbox" type="text" name="raiseMoney" id="raiseMoney" value="${preProduct.raiseMoney }"  style="height:35px;margin:0 0;width:30%;" maxlength="10" />元
											<span id="Money_msg" style="color: red;"></span>
										</td>
										<td class="kv-label">众筹目标&nbsp;<font color="red">*</font></td>
										<td class="kv-content" colspan="2">
											<input class="easyui-numberbox" type="text" name="raiseTarget" id="raiseTarget" value="${preProduct.raiseTarget }"  style="height:35px;margin:0 0;width:30%;" maxlength="10"/>元
									...
									<tr>
										<td class="kv-label">支付人数&nbsp;<font color="red">*</font></td>
										<td class="kv-content" colspan="2">
											<input class="numberbox" type="text" name="supportNum" id="supportNum" value="${preProduct.supportNum }"  style="height:35px;margin:0 0;width:20%;" onkeyup="this.value=this.value.replace(/[^0-9-]+/,'');"/>&nbsp;位
											<span id="Time_msg" style="color: red;"></span>
										</td> 
										<td class="kv-label">发货时间&nbsp;<font color="red">*</font></td>
										<td class="kv-content" colspan="2">
											<input class="easyui-datetimebox" type="text" name="deliverTime" id="deliverTime" value="${preProduct.deliverTime }"  style="height:35px;margin:0 0;width:220px;"/>
									...
									<tr>
										...
										<td class="kv-content" colspan="2">
											<input class="numberbox" type="text" name="rankOrder" id="rankOrder" value="${preProduct.rankOrder }"  style="height:35px;margin:0 0;width:20%;" onkeyup="this.value=this.value.replace(/[^0-9-]+/,'');"/>
								...
								<tbody>
									<tr>
										...
										<td class="kv-content" colspan="3">
											<input  type="hidden" name="productLogo" id="productLogo" value="${preProduct.productLogo }"/>
											<span id="productLogo1" style="color: red;"></span>
											<div id="zyupload">
											</div>
										</td>
										<td class="kv-label" colspan="2" id="pics">
											<img id="pimg" src="${preProduct.productLogo }" width="80%"/>
										</td>
									</tr>
								</tbody>
							</table>
		...
		<script type="text/javascript" src="${resourcepath}/admin/js/pre/edit_preproduct.js"></script>
		<script type="text/javascript">
			var start = '${preProduct.raiseStart }';
			var end = '${preProduct.raiseEnd }';
			var deliverTime= '${preProduct.deliverTime }';
