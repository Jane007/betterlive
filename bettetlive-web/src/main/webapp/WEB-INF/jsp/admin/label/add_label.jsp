...
<body>
	<div class="container">
		<div class="content">
			<div class="easyui-tabs1" style="width: 100%;">
				<div title="添加标签信息" data-options="closable:false" class="basic-info">
					<div class="column">
						<span class="current">基础信息</span>(<font color="red">*</font>&nbsp;是必填项)
					</div>
					<form id="specialform" name="specialform"
						action="${mainServer}/admin/label/addlabel"
							...
							<tr>
								...
								<tr>
									...
									<td class="kv-content" colspan="3">
										<input id="labelName" name="labelName" class="textbox" style="height:35px;margin:0 0;width:220px;" maxlength="100" >
								...
								<tr>
									...
									<td class="kv-content" colspan="3">
										<input id="labelSort" name="labelSort" class="textbox" style="height:35px;margin:0 0;width:220px;" maxlength="100" >
									 	<span id="Name_msg" style="color: red;"></span>
									</td>
								</tr>
								<tr>
	...
	<script type="text/javascript" src="${resourcepath}/admin/js/label/add_label.js"></script>
