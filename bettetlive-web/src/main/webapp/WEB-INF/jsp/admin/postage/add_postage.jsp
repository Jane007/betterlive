...
<body>
							...
							<tbody>
								<tr>
									...
									<td class="kv-content" colspan="3">
										<input id="postageName" name="postageName" class="textbox" style="height:35px;margin:0 0;width:220px;" maxlength="100" >
								...
								<tr>
									<td class="kv-label">包邮的条件（元）:&nbsp;<font color="red">*</font></td>
									<td class="kv-content" colspan="3">
										<input id="meetConditions" name="meetConditions" class="textbox" style="height:35px;margin:0 0;width:220px;" maxlength="100" >
									 	<span id="meetConditions_msg" style="color: red;">只能输入整数金额</span>
									</td>
								</tr>
								<tr>
									<td class="kv-label">运费:&nbsp;<font color="red">*</font></td>
									<td class="kv-content" colspan="3">
										<input id="postage" name="postage" class="textbox" style="height:35px;margin:0 0;width:220px;" maxlength="100" >
								...
								<tr>
									...
									<td class="kv-content" colspan="3">
										<input id="postageMsg" name="postageMsg" class="textbox" style="height:35px;margin:0 0;width:220px;" maxlength="100" >
	...
	<script type="text/javascript" src="${resourcepath}/admin/js/postage/add_postage.js"></script>
</body>
</html>