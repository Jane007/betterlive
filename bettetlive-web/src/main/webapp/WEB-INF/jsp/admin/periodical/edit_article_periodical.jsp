...
<html>
	<head>
		...
		<script type="text/javascript" src="${resourcepath}/admin/js/periodical/edit_article_periodical.js"></script>
		<!-- 富文本编辑器 -->
		...
		<div class="container">
			<div class="content">
				<div class="easyui-tabs1" style="width:100%;">
			      <div title="修改文章期刊" data-options="closable:false" class="basic-info">
			      		<form id="postForm" name="postForm" method="post" enctype="multipart/form-data">
			      			<input type="hidden" id="periodicalId" name="periodicalId" value="${articlePeriodicalVo.periodicalId}">
					      	...
					      	<table class="kv-table">
								<tbody>
									<tr>
										...
										<td class="kv-content">
											<input class="textbox" type="text" name="periodical" id="periodical" placeholder="如：第1期" value="${articlePeriodicalVo.periodical}"
									...
									<tr>
										...
										<td class="kv-content">
											<input class="easyui-textbox" type="text" name="periodicalTitle" id="periodicalTitle" value="${articlePeriodicalVo.periodicalTitle}"
