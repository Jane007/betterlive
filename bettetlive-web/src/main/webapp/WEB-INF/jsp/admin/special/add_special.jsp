...
<html>
	...
	<body>
			...
			<div class="content">
				<div class="easyui-tabs1" style="width:100%;">
			      <div title="添加专题信息" data-options="closable:false" class="basic-info">
			      		...
			      		<form id="specialform" name="specialform" action="${mainServer}/admin/special/add"  method="post" enctype="multipart/form-data">
					      	...
					      	<table class="kv-table">
								<tbody>
									...
									<tr>
										...
										<td class="kv-content">
											<input class="easyui-filebox" type="text" name="file1" id="specialPage" data-options="buttonText:'上传文件'" style="height:35px;margin:0 0;width:220px;"/>
							...
							<div class="column" style="display:none" id="spec"><span class="current">产品规格--原价--专题价格</span></div>
							<table class="kv-table">
		...
		<script type="text/javascript" src="${resourcepath}/admin/js/special/add_special.js"></script>
	</body>
</html>