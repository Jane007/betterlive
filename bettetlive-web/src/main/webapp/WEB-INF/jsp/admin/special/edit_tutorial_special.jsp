...
<html>
	...
	<body>
		<div class="container">
			<div class="content">
				<div class="easyui-tabs1" style="width:100%;">
			      <div title="修改美食教程" data-options="closable:false" class="basic-info">
			      		...
			      		<form id="specialform" method="post" enctype="multipart/form-data">
					      	...
					      	<table class="kv-table">
								<tbody>
									...
									<tr>
										...
										<td class="kv-content">
											<input class="easyui-textbox" type="text" name="objValue" id="objValue" value="${special.objValue}" style="height:35px;margin:0 0;width:220px;"/>
									...
									<tr>
										...
										<td class="kv-label">美食教程介绍&nbsp;<font color="red">*</font></td>
										<td class="kv-content">
									...
									<tr>
										<td class="kv-label">美食教程路径&nbsp;<font color="red">*</font></td>
										<td class="kv-content" colspan="3">
											<input class="textbox" type="text" name="specialPage" id="specialPage" value="${special.specialPage }"  style="height:35px;margin:0 0;width:86.5%;"/>
							...
							<div class="column" id="spec"><span class="current">产品规格--原价--活动价格</span></div>
							<table class="kv-table">
								<tbody id="spectbl">
									<tr>
							...
							<div class="column"><span class="current">美食教程封面图片</span></div>
							<table class="kv-table">
								<tbody>
									<tr>
										<td class="kv-label" >美食教程封面图片&nbsp;<font color="red">*</font><br/>(720x316)</td>
										<td class="kv-content" colspan="3">
		...
		<script type="text/javascript">
			...
			var objTypeId = "${special.objTypeId}";
			if(objTypeId != null && objTypeId > 0){
				$("#objTypeId").val(objTypeId);
			}
		</script>
		<script type="text/javascript" src="${resourcepath}/admin/js/special/edit_tutorial_special.js"></script>
	</body>
</html>