...
<html>
	...
	<body>
		<div class="container">
			<div class="content">
				<div class="easyui-tabs1" style="width:100%;">
			      <div title="添加拼团活动信息" data-options="closable:false" class="basic-info">
			      		...
			      		<input id="productId" name="productId" type="hidden">
					      	<table class="kv-table">
								...
								--%>
									...
									<tr>
										<td class="kv-label">可开团数量&nbsp;<font color="red">*</font></td>
										<td class="kv-content">
											<input class="textbox" type="text" name="groupCopy" id="groupCopy"  style="height:35px;margin:0 0;width:220px;" maxlength="100"/>
											<span id="groupCopy_msg" style="color: red;"></span>
										</td>
										<td class="kv-label">每个团可参与人数&nbsp;<font color="red">*</font></td>
										<td class="kv-content">
											<input class="easyui-textbox" type="text" name="limitCopy" id="limitCopy" style="height:35px;margin:0 0;width:220px;"/>
											<span id="limitCopy_msg" style="color: red;"></span>
										</td>
									</tr>
									<tr>
										<td class="kv-label">团购开始时间&nbsp;<font color="red">*</font></td>
										<td class="kv-content">
										...
										<td class="kv-label">团购结束时间&nbsp;<font color="red">*</font></td>
										<td class="kv-content">
									...
									<tr>
										...
										<td class="kv-content" colspan="3">
											<input type="text" name="desc1" id="desc1" style="width: 60%;">
									...
									<tr>
										...
										<td class="kv-content" colspan="3">
											<input type="text" name="desc2" id="desc2" style="width: 60%;">
											<span id="rul1_msg" style="color: red;">最多4点规则描述</span>
										</td>
									</tr>
									<tr>
										...
										<td class="kv-content" colspan="3">
											<input type="text" name="desc3" id="desc3" style="width: 60%;">
											<span id="rul1_msg" style="color: red;">最多4点规则描述</span>
										</td>
									</tr>
									<tr>
										...
										<td class="kv-content" colspan="3">
											<input type="text" name="desc4" id="desc4" style="width: 60%;">
											<span id="rul1_msg" style="color: red;">最多4点规则描述</span>
										</td>
									</tr>
								</tbody>
							...
							<div class="column" style="display:none" id="spec"><span class="current">产品规格--原价--拼团活动价格</span></div>
							<table class="kv-table">
							...
							<table class="kv-table">
								...
								<%-- 
									<tr>
										<td class="kv-label">
											<div style="font-size: 12px;font-weight: bolder;" align="center">团购列表图</div>
										</td>
										<td class="kv-content" colspan="5" >
		...
		<script type="text/javascript" src="${resourcepath}/admin/js/special/add_group_special.js"></script>
	</body>
</html>