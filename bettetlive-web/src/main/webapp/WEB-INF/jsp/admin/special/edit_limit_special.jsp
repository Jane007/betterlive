							...
							<input type="hidden" id="activityType" name="activityType" value="${activityType}">
					      	...
					      	<table class="kv-table">
								...
								--%>
									...
									<tr>
										<td class="kv-label">限量抢购开始时间&nbsp;<font color="red">*</font></td>
										<td class="kv-content">
										...
										<td class="kv-label">限量抢购结束时间&nbsp;<font color="red">*</font></td>
										<td class="kv-content">
									...
									<tr>
										...
										<td class="kv-label">限量抢购介绍&nbsp;<font color="red">*</font></td>
										<td class="kv-content">
...
<!-- 											<span class="addTea" onclick="chooseProduct()" >选择</span>											 -->
							...
							<div class="column" id="spec"><span class="current">产品规格--原价--限量抢购价格</span></div>
							<table class="kv-table">
								<tbody id="spectbl">
									<tr>
							...
							<div class="column"><span class="current">限量抢购封面图片</span></div>
							<table class="kv-table">
								<tbody>
									<tr>
									...
									<tr>
										<td class="kv-label">
											<div style="font-size: 12px;font-weight: bolder;" align="center">抢购图</div>
										</td>
										<td class="kv-content" colspan="5" >
		...
		<script type="text/javascript" src="${resourcepath}/admin/js/special/edit_limit_special.js"></script>
	</body>
</html>