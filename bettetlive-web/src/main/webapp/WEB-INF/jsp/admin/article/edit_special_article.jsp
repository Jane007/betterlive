...
<html>
	...
	<body>
			      ...
			      <div title="修改专题信息" data-options="closable:false" class="basic-info">
			      		...
			      		<form id="specialform"  method="post" enctype="multipart/form-data">
					      	...
					      	<table class="kv-table">
								<tbody>
									<tr>
										<td class="kv-label">专题文章标题&nbsp;<font color="red">*</font></td>
										<td class="kv-content">
										...
										<td class="kv-content">
											<input class="easyui-textbox" type="text" name="author" id="author" style="height:35px;margin:0 0;width:220px;" value="${article.author}"/>
									...
									<tr>
										...
										<td class="kv-content">
											<select name="recommendFlag" id="recommendFlag" style="height:35px;width: 120px;">
												<c:if test="${article.recommendFlag == 1}">
													<option value="1" selected="selected">是</option>
													<option value="0">否</option>
												</c:if>
												<c:if test="${article.recommendFlag == 0}">
													<option value="1">是</option>
													<option value="0" selected="selected">否</option>
												</c:if>
											</select>
									...
									<tr>
										<td class="kv-label">专题文章介绍&nbsp;<font color="red">*</font></td>
										...
										<td class="kv-content">
											<input class="easyui-filebox" type="text" name="homeCover" id="homeCover"
						                      data-options="buttonText:'选择图片',accept:'image/jpeg,image/png,image/gif,image/JPEG,image/PNG,image/GIF', onChange:function(){previewImg($(this));}"/>
												<span style="color: red;"></span><div class="homeCoverShow"><img style="width:60px;height:60px;" src="${article.homeCover}"></div>
										</td>
									</tr>
								</tbody>
							</table>
								...
								<tbody>
									<tr>
										...
										<td class="kv-label" colspan="2" id="pics">
											<img id="pimg" src="${article.articleCover }" width="160px"/>
										</td>
									</tr>
								</tbody>
							</table>
		...
		<script type="text/javascript" src="${resourcepath}/admin/js/article/edit_special_article.js"></script>
	</body>
</html>