...
<html>
	...
	<body>
		  <table id="StoreGrid" style="width:100%;height:700px;" title="社区文章列表">
	      </table>
...
<!-- 						<input id="endTime" name="endTime"  class="easyui-datebox" data-options="formatter:myformatter,parser:myparser"/> -->
		      	...
		      	<div>
<!-- 		      	   <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-add" data-options="iconCls:'icon-list'" onclick="toAddSpecialArticle()">增加文章</a> -->
			       ...
			       <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-edit" data-options="iconCls:'icon-list'" id="delConfBtn1"   onclick="toDelSpecialArticle(1)">审核通过</a>
			       <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-remove" data-options="iconCls:'icon-list'" id="delConfBtn2"   onclick="toDelSpecialArticle(4)">审核不通过</a>
      	...
      	<script type="text/javascript" src="${resourcepath}/admin/js/article/list_circle_article.js"></script>
	</body>
</html>