...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			var productDisable = '${productDisable}';
	...
	<body>
		<div class="container">
			<div class="content">
	      		<form id="productform" action="${mainServer}/admin/product/add" method="post" enctype="multipart/form-data">
				...
				<div class="easyui-tabs1" style="width:100%;">
					<div title="商品基本信息" data-options="closable:false" class="basic-info">
								...
								<tbody>
									<tr>
										...
										<td class="kv-content" colspan="2">
											<input class="textbox" type="text" name="productName" id="productName" style="height:35px;margin:0 0;width:220px;" maxlength="50"/>
									...
									<tr>
										...
										<td class="kv-content" colspan="2">
											<input class="numberbox" type="text" name="order_num" id="orderNum" style="height:35px;margin:0 0;width:15%;" onkeyup="value=value.replace(/[^\d]/g,'')"/>
											数字越小排位越前
									...
									<tr>
										...
										<td class="kv-content" colspan="2">
											<select name="ifCoupon" style="height:35px;margin:0 0;width:120px;">
									...
									<tr>
										...
										<td class="kv-content" colspan="5" >
											...
											<div id="tea_1" style="float:left;">
												<div id="paramAndValue_1" name="paramAndValue_1">
													<input class="textbox" type="text" name="sizeOrParam_1" id="sizeOrParam_1" style="height:35px;margin:0 0;width:125px;" maxlength="15"/>—
													<input class="textbox" type="text" name="sizeOrValue_1" id="sizeOrValue_1" style="height:35px;margin:0 0;width:125px;" maxlength="20"/>
												</div>
											</div>
									...
									<tr>
										<td class="kv-label" colspan="6">
											<div style="font-size: 14px;font-weight: bolder;" align="center">
												规格—原价—优惠价（没有优惠价则填-1）—库存—限购（-1代表不限购）—限购开始时间—限购结束时间  &nbsp;&nbsp; <br/>示例:<input  style="color: red;width: 80px;" value="5千克" readonly="readonly"/>—
										      	<input style="color: red;width: 50px;" value="120" readonly="readonly" /> 元（原价）
								      	    	<input style="color: red;width: 50px;" value="100" readonly="readonly"/> 元（优惠价）
										      	...
										      	—<input style="color: red;width: 170px;" value="2017-05-11 00:00:00" readonly="readonly" />
										      	—<input style="color: red;width: 170px;" value="2017-05-15 00:00:00" readonly="readonly" />
										      	&nbsp;&nbsp;&nbsp;规格图片大小   120x120
									...
									<tr>
										...
										<td class="kv-content" colspan="5" >
											...
											<div id="product_1" style="float:left;">
												<div id="keyAndValue_1" name="keyAndValue_1" class="prospec_item">
													<input class="textbox" type="text" name="teaSize_1" id="teaSize_1" style="height:33px;width:80px;" maxlength="15"/>&nbsp;—
													<input class="easyui-numberbox" type="text" name="teaSizePrice_1" id="teaSizePrice_1" 
														style="height:33px;width:70px;" data-options="min:0,precision:2,max:10000" maxlength="8" />&nbsp;元（原价）&nbsp;
													<input class="easyui-numberbox" type="text" name="teaDiscountPrice_1" id="teaDiscountPrice_1" placeholder="没有填-1"
														style="height:33px;width:70px;" data-options="min:-1,precision:2,max:10000" maxlength="8" value="-1" />&nbsp;元（优惠价）&nbsp;
														<input class="easyui-numberbox" type="text" name="teaCopy_1" id="teaCopy_1" 
														style="height:33px;width:70px;" data-options="min:0,max:10000" maxlength="8" />件
													<input class="numberbox" type="text" name="teaLimitMaxCopy_1" id="teaLimitMaxCopy_1" value="-1"
                     							 ...
                     							 <input class="easyui-datetimebox" type="text" name="teaLimitStartTime_1"  id="teaLimitStartTime_1"  style="height:35px;margin:0 0;width:170px;"/>
                      							<input class="easyui-datetimebox" type="text" name="teaLimitEndTime_1"  id="teaLimitEndTime_1"  style="height:35px;margin:0 0;width:170px;"/>
													<div style="padding-left:10px; width: 170px;display: inline-block;">
														规格图片
														<input class="easyui-filebox" type="text" name="specImg1" id="specImg1" style="height:35px;margin:0 0;width:60px;" 
														...
														<span id="specimg_msg1" style="color: red;"></span>
														<div class="specImgPrev" style="width: 40px;"></div>
													</div>
													<div style="display: inline-block;padding-left: 20px;">
														套餐说明&nbsp;&nbsp;&nbsp;<input type="text" class="textbox" name="teaPackageDesc_1" style="height:33px;width:250px;margin-top:10px;font-size: 14px;" maxlength="50"/>
													</div>
												</div>
											</div>
											<div id="product_2" style="float:left;margin-top: 10px;">
												
											</div>
											<div id="product_3" style="float:left;margin-top: 10px;">
									...
									<%-- <tr>
										<td class="kv-label">
											<div style="font-size: 12px;font-weight: bolder;" align="center">不配送地区</div>
										</td>
										<td class="kv-content" colspan="5" >
											...
											<span class="addTea" onclick="chooseAddress()" >选择</span>											
									...
									<tr>
										...
										<td class="kv-content" colspan="5" >
											<input class="easyui-filebox" type="text" name="homeweekly_first_img" id="homeweeklyFirstImg" style="height:35px;width:60px;"
						                      data-options="buttonText:'选择图片',accept:'image/jpeg,image/png,image/gif,image/JPEG,image/PNG,image/GIF', onChange:function(){previewImg($(this));}"/>
												<span style="color: red;"></span><div class="homeweeklyFirstImgShow"></div>
										</td>
									</tr>
									<tr>
										<td class="kv-label">
										...
										<td class="kv-content" colspan="5" >
						                      ...
						                      data-options="buttonText:'选择图片',accept:'image/jpeg,image/png,image/gif,image/JPEG,image/PNG,image/GIF', onChange:function(){previewImg($(this));}"/>
												<span style="color: red;"></span><div class="homeweeklyAfterImgShow"></div>
										</td>
									</tr>
									<tr>
										<td class="kv-label">
										...
										<td class="kv-content" colspan="5" >
											<input class="easyui-filebox" type="text" name="homefame_img" id="homefameImg" style="height:35px;width:60px;"
						                      data-options="buttonText:'选择图片',accept:'image/jpeg,image/png,image/gif,image/JPEG,image/PNG,image/GIF', onChange:function(){previewImg($(this));}"/>
												<span style="color: red;"></span><div class="homefameImgShow"></div>
										</td>
									</tr>
							</tbody>
						</table> 
			      	...
			      	<div title="商品图片" data-options="closable:false" class="basic-info">
			      		...
			      		<iframe name="proLogoFrm" src="productlogo.html" width="100%" height="350px">
							
						</iframe>
						<div class="column"><span class="current">商品轮播图</span></div>
						<iframe name="proBannerFrm" src="productbanner.html" width="100%" height="350px">
		...
		<%-- <div id="dlg" class="easyui-dialog" title="选择地区" data-options="closed:true" style="width:700px;height:500px;padding:10px;">
	      	<table class="kv-table">
				<tbody>
					<tr>
							<c:forEach items="${list}"  var="l">
			           			<c:if test="${l.areaId == shop.provinceId}">
			           				<option value="${l.areaId}" selected="selected" >${l.areaName}</option>
			           			</c:if>
			           		    <c:if test="${l.areaId != shop.provinceId}">
			           		    	<option value="${l.areaId}" >${l.areaName}</option>
			           			</c:if>      class="waiteTea" 
			           			 <span class="waiteTea"  id="${l.areaId}" title="${l.areaName}"  onclick="addCreateAddress(this)" >${l.areaName}</span> 
			           		</c:forEach>						
							
							<div style="padding:35px" align="center">
								<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-edit" data-options="selected:true" onclick="isSureAddress()">确定</a>
								<a href="javascript:void(0)" class="easyui-linkbutton"  data-options="selected:true" onclick="closeAddress()" >关闭</a>
                            </div>
					</tr>
				</tbody>	
			</table>
		...
		<script type="text/javascript" src="${resourcepath}/admin/js/product/add_product.js"></script>
	</body>
</html>