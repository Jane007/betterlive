...
<body>
	<form id="messageSendForm" method="post">
			...
			<tbody>
				<tr>
					<td class="kv-label">消息类型</td>
					<td class="kv-content">
						<select id="modifyMsgType" name="msgType" style="width:100px;height:31px;line-height:31px;" onchange="changeMsgType(this.value)">
...
--%>
				...
				<tr>
					<td class="kv-label">消息详细分类</td>
					<td class="kv-content">
						<select id="modifySubMsgType" name="subMsgType" style="width:100px;height:31px;line-height:31px;" onchange="changeSubMsgType(this.value)">
							<option value="0" selected="selected">系统公告</option>
							<option value="8">物流公告</option>
						</select>
					</td>
				</tr>
				<tr>
					...
					<td class="kv-content">
						<input class="easyui-textbox" name="msgTitle" id="msgTitle" value="系统公告" data-options="required:true" missingMessage="不能为空" style="height:35px;margin:0 0;width: 270px;"/>
						<a id="choiceActShow" href="javascript:choiceActivity();" style="display: none;">选择活动</a>
       ...
       <div id="actdlg" class="easyui-dialog" title="选择活动" data-options="closed:true" style="width:1100px;height:600px;padding:10px;">
	      	 <table id="activityGrid" style="width:100%;height:229px;" title="活动列表">
      		 </table>
   	...
   	<script type="text/javascript" src="${resourcepath}/admin/js/msg/edit_message.js"></script>
</body>
</html>