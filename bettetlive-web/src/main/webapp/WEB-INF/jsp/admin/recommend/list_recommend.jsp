...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			var recommadSize = '${size}';
	    </script>
	</head>
	
	<body>
		  <table id="StoreGrid" style="width:100%;height:529px;" title="人气推荐商品列表">
	        
	      </table>
	      
	      <div id="storeToolbar" style="padding:0 30px;">
	      		<div id="tb" style="padding:0 30px;">
				     <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-add" data-options="iconCls:'icon-list'" id="addConfBtn" onclick="addOpenDlg()">增加人气商品</a>
				     <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-edit" data-options="iconCls:'icon-list'" id="updConfBtn"   onclick="toEditRecommend()">修改人气商品</a>
		      		 <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-remove'" id="delConfBtn"   onclick="delRecommend()">删除人气商品</a>
		...
		<div id="dlg" class="easyui-dialog" title="新增人气推荐商品" data-options="closed:true"  fit=“true”  style="width:620px;height:420px;padding:10px;">
    		<form  id="form1" action="" method="post">
    			
		       	<table class="kv-table">
					<tbody>
						<tr>
							<td class="kv-label">推荐商品名称</td>
							<td class="kv-content">
		...
		<script type="text/javascript" src="${resourcepath}/admin/js/recommend/list_recommend.js"></script>
	</body>
</html>