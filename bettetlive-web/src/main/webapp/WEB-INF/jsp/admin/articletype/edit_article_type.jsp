...
<html>
	...
	<body>
		<div class="container">
			<div class="content">
				<div class="easyui-tabs1" style="width:100%;">
			      <div title="修改文章分类" data-options="closable:false" class="basic-info">
			      		...
			      		<form id="dataform" name="dataform" method="post" enctype="multipart/form-data">
			      			<input type="hidden" id="typeId" name="typeId" value="${sart.typeId}">
					      	<table class="kv-table">
								<tbody>
									<tr>
										<td class="kv-label">分类名称&nbsp;<font color="red">*</font></td>
										<td class="kv-content">
											<input class="easyui-textbox" type="text" name="typeName" id="typeName" value="${sart.typeName}"
												style="height:35px;margin:0 0;width:220px;"/>
											<span id="name_msg" style="color: red;"></span>
										</td>
										<td class="kv-label">排序&nbsp;<font color="red">*</font></td>
										<td class="kv-content">
											<input class="easyui-textbox" type="text" name="sort" id="sort" value="${sart.sort}"
												style="height:35px;margin:0 0;width:220px;"/>
									...
									<tr>
										...
										<td class="kv-content">
											<select name="status" id="status" style="height:35px;width: 120px;">
												<c:if test="${sart.status == 1}">
													<option value="1" selected="selected">正常</option>
													<option value="0">失效</option>
												</c:if>
												<c:if test="${sart.status == 0}">
							...
							<table class="kv-table">
								<tbody>
									<tr>
										...
										<input  type="hidden" name="typeCover" id="typeCover" value="${sart.typeCover}"/>
										<span id="typeCover1" style="color: red;"></span>
											<div id="zyupload">
											</div>
										</td>
										<td class="kv-label" colspan="2" id="pics">
											<img id="pimg" src="${sart.typeCover}" width="160px"/>
										</td>
									</tr>
								</tbody>
							</table>
		...
		<script type="text/javascript" src="${resourcepath}/admin/js/articletype/edit_article_type.js"></script>
	</body>
</html>