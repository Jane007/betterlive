...
<body>
	<div class="container">
		<div class="content">
			<div class="easyui-tabs1" style="width: 100%;">
				<div title="添加菜单信息" data-options="closable:false" class="basic-info">
					<div class="column">
					...
					<form id="specialform" name="specialform"
						...
						<table class="kv-table">
							<tbody>
								<tr>
									<td class="kv-label">父级菜单:&nbsp;<font color="red">*</font></td>
									<td class="kv-content" colspan="3">
										<input type="hidden" value="1" id ="menuType" name="menuType"/>
								...
								<tr>
									...
									<td class="kv-content" colspan="3">
										<input id="menuName" name="menuName" class="textbox" style="height:35px;margin:0 0;width:220px;" maxlength="100" >
								...
								<tr>
									...
									<td class="kv-content" colspan="3">
										<input id="menuUrl" name="menuUrl" class="textbox" style="height:35px;margin:0 0;width:220px;" maxlength="100" >
								...
								<tr>
									...
									<td class="kv-content" colspan="3">
										<input id="menuOrd" name="menuOrd" class="textbox" style="height:35px;margin:0 0;width:220px;" maxlength="100" >
	...
	<script type="text/javascript" src="${resourcepath}/admin/js/menu/add_menu.js"></script>
</body>
</html>