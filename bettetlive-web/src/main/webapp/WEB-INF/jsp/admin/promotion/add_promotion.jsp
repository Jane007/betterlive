...
<html>
	...
	<body>
			...
			<div class="content">
				<div class="easyui-tabs1" style="width:100%;">
			      <div title="添加促销活动" data-options="closable:false" class="basic-info">
					      	...
					      	<table class="kv-table">
								<tbody>
									<tr>
										...
										<td class="kv-content">
											<input class="textbox" type="text" name="promotionName" id="promotionName" style="height:35px;margin:0 0;width:280px;" maxlength="100"/>
										...
										<td class="kv-content">
											满<input class="textbox" type="text" name="fullMoney" id="fullMoney"  style="height:35px;margin:0 0;width:80px;" maxlength="5" onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9.]+/,'');}).call(this)"/>
											减<input class="textbox" type="text" name="cutMoney" id="cutMoney"  style="height:35px;margin:0 0;width:80px;" maxlength="5" onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9.]+/,'');}).call(this)"/>
									...
									<tr>
										...
										<td class="kv-content"  colspan="3">
											<input class="textbox" type="text" name="promotionContent" id="promotionContent" style="height:35px;margin:0 0;width:90%;" maxlength="100"/>
						...
						<%--  
							<div class="column" id="sendMsgShow"><span class="current">推送消息至公众号</span></div>
							<table class="kv-table">
								<tbody id="massMsgTbl">
									<tr>
										<td class="kv-label" style="width:200px">
											<span style="color: red;">是否推送（如果推送请勾选）</span>
											<input type="checkbox" name="massMsg" id="massMsg">
										</td>
										<td id="addSpec" class="kv-label" colspan="5" >
											<input type="text" id="massUrl" name="massUrl" placeholder="推送消息的活动URL全路径地址" style="width: 270px;">
											<span style="color: red;">（每月仅限四次推送，超过4次，用户将无法收到，操作前请询问技术人员）</span>
										</td>
									</tr>
								</tbody>
							</table>
		...
		<script type="text/javascript" src="${resourcepath}/admin/js/promotion/add_promotion.js"></script>
	</body>
</html>