...
<html>
	<head>
		...
		<script type="text/javascript" src="${resourcepath}/admin/js/productcomment/comment_detail.js"></script>
	...
	<body>
		...
		<div class="plboxs" >
			<!-- <div class="pllls">
				<div class="pltopbox">
					<span><strong>哇哈哈</strong>评论<strong>哇哈哈</strong></span> 
				</div> 
				<div class="nrboxs"> 
					我是内容我是内容我是内容我是内容我是内容我是内容我是内容我是内容我是内容我是内容我是内容我是内容我是内容我是内容我是内容我是内容内容我是内容我是内容我是内容我是内容我是内容我是内容我是内容我是内容我是内容我是内容我是内容我是内容我是内容我是内容我是内容我是内容我是内容我是
				</div>
				<div class="inputbox"> 
					<textarea rows="7" cols="30" placeholder="请输入回复内容"></textarea> 
					<a href="#">回复</a>   
				</div>
			</div>  -->
		</div>
