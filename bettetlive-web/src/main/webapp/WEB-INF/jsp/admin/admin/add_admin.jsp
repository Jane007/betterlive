...
<body>
	<div class="container">
		<div class="content">
			<div class="easyui-tabs1" style="width: 100%;">
				<div title="添加管理员信息" data-options="closable:false" class="basic-info">
					<div class="column">
						<span class="current">基础信息</span>(<font color="red">*</font>&nbsp;是必填项)
					</div>
					<form id="specialform" name="specialform"
						action="${mainServer}/admin/admin/adminvo"
							...
							<tbody>
								<tr>
									...
									<td class="kv-content" colspan="3">
										<input id="username" name="username" class="textbox" style="height:35px;margin:0 0;width:220px;" maxlength="100" >
								...
								<tr>
									...
									<td class="kv-content" colspan="3">
										<input id="loginname" name="loginname" class="textbox" style="height:35px;margin:0 0;width:220px;" maxlength="100" >
									 	<span id="loginname_msg" style="color: red;"></span>
									</td>
								</tr>
								<tr>
									<td class="kv-label">登录密码:&nbsp;<font color="red">*</font></td>
									<td class="kv-content" colspan="3">
										<input id="passwo" name="passwo" class="textbox" style="height:35px;margin:0 0;width:220px;" maxlength="100" >
										<input id="password" name="password" class="textbox"  maxlength="100" type="hidden" >
								...
								<tr>
									...
									<td class="kv-content" colspan="3">
										<input id="mobile" name="mobile" class="textbox" style="height:35px;margin:0 0;width:220px;" maxlength="100" >
									</td>
								</tr>
								<tr>
								...
								<tr>
									<td class="kv-label">分配角色:&nbsp;<font color="red">*</font></td>
									<td class="kv-content" colspan="3"><select id="roleId" name="roleId" style="width:100px;height:31px;line-height:31px;">
											<option value="" selected="selected">请选择</option>
											<c:forEach var="role" items="${roles }">
											<option value="${role.roleId }" >${role.roleName }</option>
											</c:forEach>
									</select><span id="roleId_msg" style="color: red;"></span> </td>
								</tr>
							</tbody>
						</table>
						<table class="kv-table">
	...
	<script type="text/javascript" src="${resourcepath}/admin/js/admin/add_admin.js"></script>
</body>
</html>