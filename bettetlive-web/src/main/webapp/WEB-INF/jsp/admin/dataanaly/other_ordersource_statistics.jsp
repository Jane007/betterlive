...
<html>
	...
	<body>
		...
		<table id="dataGrid" style="width:100%;height:529px;" title="其他平台订单来源统计"></table>
    ...
    <script type="text/javascript" src="${resourcepath}/admin/js/dataanaly/other_ordersource_statistics.js"></script>
	</body>
</html>