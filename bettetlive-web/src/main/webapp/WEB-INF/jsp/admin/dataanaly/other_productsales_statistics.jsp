...
<html>
	...
	<body>
		...
		<table id="dataGrid" style="width:100%;height:529px;" title="其他平台商品销量"></table>
   	...
   	<script type="text/javascript" src="${resourcepath}/admin/js/dataanaly/other_productsales_statistics.js"></script>
	</body>
</html>