...
<body>
	...
	<table id="dataGrid" style="width: 100%; height: 529px;"
		title="挥货用户来源统计"></table>

	<div id="dataToolbar" style="padding: 0 30px;">
		<div>
			<span class="con-span">用户来源: </span> <input class="easyui-textbox"
				type="text" name="customerSource" id="customerSource"
				style="height: 30px; width: 140px; line-height: 30px;" /> <span
				class="con-span">日期：</span> <input id="startTime" name="startTime"
				class="easyui-datebox"
				data-options="formatter:myformatter,parser:myparser"
				style="height: 30px; margin: 0 0; width: 180px;" />- <input
				id="endTime" name="endTime" class="easyui-datebox"
				data-options="formatter:myformatter,parser:myparser"
				style="height: 30px; margin: 0 0; width: 180px;" /> <span> <a
				href="javascript:void(0);" class="easyui-linkbutton"
				iconCls="icon-search" data-options="selected:true"
				onclick="queryList()">查询</a> <a id="conExport"
	...
	<script type="text/javascript" src="${resourcepath}/admin/js/dataanaly/hh_custsource_statistics.js"></script>
