...
public class IntrospectionCache {
    ...
    /** 日志对象 */
    private static Logger log = Logger.getLogger(IntrospectionCache.class);
    ...
    private IntrospectionCache(Class<?> beanClass) {
        ...
        try {
            if (log.isDebugEnabled()) {
                log.info("Getting BeanInfo for class [" + beanClass.getName() + "]");
            }
            ...
            if (log.isDebugEnabled()) {
                log.info("Caching PropertyDescriptors for class [" + beanClass.getName() + "]");
            }
