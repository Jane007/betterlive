...
public class PageView implements Serializable {
	...
	private static final long serialVersionUID = 8105524469663539355L;
	...
	private  boolean rowCountAble=true;
	...
	/**
	 * 查询结果方法
	 * 把　记录数，结果总页数，结果集合　放入到PageView对象
	 * @param rowCount 总记录数
	 * @param records 结果集合
	 */
	...
	public void setRowCountAble(boolean rowCountAble) {
		this.rowCountAble = rowCountAble;
	}
