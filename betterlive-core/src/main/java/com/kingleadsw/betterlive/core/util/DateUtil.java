...
public class DateUtil {
	...
	private static final FastDateFormat yyyyMMddHHmmssSSS = FastDateFormat.getInstance("yyyyMMddHHmmssSSS");
	...
	public static  String getDatePattern() {
		...
		try {
			...
			log.error("DateUtil/getDatePattern --error", mse);
		}
	 ...
	 * @return a string representing the date pattern on the UI
	 */
	public static Long getTimestampFormNowMinutes() {
		return System.currentTimeMillis()/1000;
	}
	
	public static Long getTimestampFormDateMinutes(Date date) {
		return date.getTime()/1000;
	}
	
	public static Long getTimestampFormDateMinutes(String strDate,String pattern) {
		Date date=DateUtil.convertStringToDate(pattern, strDate);
		return date.getTime()/1000;
	}
	...
	public static final Date convertStringToDate(String aMask, String strDate) {
		...
		if (log.isDebugEnabled()) {
			log.info("converting '" + strDate + "' to date with mask '"
					+ aMask + "'");
		}
		...
		try {
			...
			log.error("日期格式转换错误【"+ pe.getMessage()+"】", pe);
		}
	...
	public static String formatStringToDate(String strFormat,String tranFormat, String strDate){
		...
		try {
			...
			log.error("字符转成时间格式出错，strFormat字符串格式:"+strFormat, e);
		}
		return "";
	}
	...
	public static final Date convertMyStringtoDate(String pattern,
		...
		try {
			...
			log.error("ReflectHelper/getValueByFieldName --error", e);
		}
		return date;
	}
	...
	/**
	 * 使用FastDateFormat将日期转为字符串，格式为yyyyMMddHHmmssSSS
	 * @param d java.util.Date类型日期
	 * @return
	 */
	public static final synchronized String getyyyyMMddHHmmssSSS(Date d) {
	...
	public static String transformTimeNew(String time){
		return time.replace("-","");
	}
	...
	public static List<String> getTwoMonths(String begin, String end) {
		...
		try {
			...
			log.error("DateUtil/deprecation --error", e);
		}
		return list;
	...
	public static String getPreYearDate(String date, String pattern) {
		...
		try {
			...
			log.error("DateUtil/getPreYearDate --error", e);
		}
	...
	public static int dataDiffByHours(Date start, Date end) {
		long startTime = start.getTime();
		long endTime = end.getTime();
		return (int)((endTime-startTime)/(60*60*1000));
	}
	
	public static int dataDiffByMinutes(Date start, Date end) {
		long startTime = start.getTime();
		long endTime = end.getTime();
		return (int)((endTime-startTime)/(60*1000));
	}
	
	public static int dataDiffBySeconds(Date start, Date end) {
		long startTime = start.getTime();
		long endTime = end.getTime();
	...
	public static String dateToMinutesString(Date date) {
		if(date==null) return "";
	 ...
	 * @return
	 */
	public static Date getPreAfterMonth(Date date,int num) {
		Calendar c = Calendar.getInstance();
		c.setTime(date);
	...
	public static List<String> getBetweenDay(String startdate,String enddate) throws ParseException{
		...
		long   between=(end.getTime()-begin.getTime())/1000/24/3600;//除以1000是为了转换成秒
	 ...
	 * @return
	 */
	public static String getMonFirstDay(Date date,String pattern){
		Calendar c = Calendar.getInstance();
		c.setTime(date);
		c.set(Calendar.DAY_OF_MONTH, 1);
		return convertDatetoMyString(pattern, c.getTime());
	 ...
	 * @return
	 */
	public static String getMonLastDay(Date date,String pattern){
		Calendar c = Calendar.getInstance();
		c.setTime(date);
		c.add(Calendar.MONTH, 1);
		c.set(Calendar.DAY_OF_MONTH, 1);
	...
	public static int getDayNum(String start, String end) {
		...
		try {
			...
			log.error("日期格式转换错误【"+e.getMessage()+"】", e);
		}
	...
	public static String getCurrentDateInSecond(){
		...
		String createDttm = tempDate.format(new java.util.Date());
		return createDttm;
	}
