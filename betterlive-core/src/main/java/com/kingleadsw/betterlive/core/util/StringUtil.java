...
public class StringUtil {
    ...
    public static String timeCompare(String time1, String time2) {
        ...
        String performTime = sFormat.format(new Timestamp(System.currentTimeMillis()));
        ...
        try {
        	...
        	log.error("StringUtil/timeCompare --error", e);
        }
        return time1;
    }
     ...
     * @return
     */
    public static String getRecordId(String recordType, String operateProperty, String disciplineType) {
     ...
     * @return
     */
    public static String getDynamiColumnJson(List<String[]> showList, String[] feilds, String[] cnFeilds,
                                             int totalRecords) {
        ...
        for (String c : cnFeilds) {
            jsonString.append("{'header': '" + c + "','dataIndex': '" + feilds[i] + "'}, ");
            i++;
        }
     ...
     * @return
     */
    public static String getJsonDate(List<String[]> showList, String[] feilds, int totalRecords) {
        ...
        for (String[] str : showList) {
            ...
            for (String string : str) {
                ...
                String s = "";
                if (null == string || "".equals(string.trim()) || "null".equalsIgnoreCase(string.trim())) {
                    jsonString.append(s + "',");
                } else {
     ...
     * @return
     */
    public static String getModelJsonDate(List<String[]> showList, String[] feilds, int totalRecords) {
        StringBuffer jsonString = new StringBuffer();
        jsonString.append("{");
        jsonString.append("totalRecords:" + totalRecords + ",");
        jsonString.append("'results':[");
        ...
        for (String[] str : showList) {
            ...
            for (int k = 0; k < str.length; k++) {
                ...
                jsonString.append(feilds[i].trim() + ":'");
                String s = "";
                if (null == string.trim() || "".equals(string.trim()) || "null".equalsIgnoreCase(string.trim())) {
                    jsonString.append(s + "',");
    ...
    public static List<String[]> getResult(List<String[]> resultList, List<Integer> cs, List<String> img) {
     ...
     * @return
     */
    public static String getStringFormatIn(String str, Map replaceStr, Map strType) {
        String[] format = str.split("@");
        List<String> fieldList = new ArrayList<String>();// 字段名
        List<String> valueList = new ArrayList<String>();// 值
        int i = 0;
     ...
     * @return
     */
    public static List<String[]> getFiterDate(List<String[]> resultList, List<String> fieldList) {
    ...
    public static String getFloorFlag(int floor, int currentFloor, String symbol) {
        ...
        if (currentFloor == 1) {
            ...
            buf.append("(").append(numberToLarge(floor)).append(")").append(symbol);
            ...
            buf.append(temp).append(floor).append(")").append(symbol);

        } else if (currentFloor == 4) {

            buf.append(temp).append("(").append(floor).append(")").append(symbol);

        } else if (currentFloor == 5) {

            buf.append(temp).append(getNumberFlag(floor)).append(symbol);
    ...
    public static String convertBlobToStringOracle(InputStream input) {
        ...
        try {
        	...
        	log.error("StringUtil/convertBlobToStringOracle --error", e);
        }
            ...
            for (Field fd : obj.getClass().getDeclaredFields()) {
                ...
                if (fd.getName().equals(propName)) {
                    try {
                    	...
                    	log.error("StringUtil/getObjectPropValues --error", e);
                    }
                    continue;
                }
            }
    ...
    public static List subList(List list, Integer start, Integer end) {
        ...
        if (end <= start) {
            try {
                throw new Exception ("索引错误：end <= start--"+end+"<="+start);
            } catch (Exception e) {
            	log.error("StringUtil/subList --error", e);
            }
        }
    ...
    public static String getformatNum(String str) {
        ...
        try {
        	...
        	log.error("StringUtil/getformatNum --error", e);
        }
    ...
    public static String RMBUpperCase(String mstr) {
        ...
        try {
        	...
        	log.error("StringUtil/RMBUpperCase --error", e);
            return "格式金额数字非法";
        }
     ...
     * @return
     */
    public static String moneyFormat(Object d, String pattern) {
        ...
        try {
            ...
            log.error("格式化金额异常："+ e.getMessage());
        }
        DecimalFormat df = new DecimalFormat(pattern);
        try {
   ...
   public static String shopCode(){
	   String shopCode="XC";
	   shopCode+=(int) ((Math.random()*9+1)*10000);
	   return shopCode;
   } 
	...
	public static String removeSpecialCharacter(String str){
		...
		str=str.replaceAll("\\,", "&a8008a&");
		str=str.replaceAll("\\_", "&b9009b&");
		return str;
	}
	...
	public static String generateShortUuid() {  
	    ...
	    shortBuffer.append(sdf.format(new Date()));
