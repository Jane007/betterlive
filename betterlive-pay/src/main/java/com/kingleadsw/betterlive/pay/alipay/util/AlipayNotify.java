...
public class AlipayNotify {
    ...
    private final static Logger logger=Logger.getLogger(AlipayNotify.class);
	...
	private static boolean getSignVeryfy(Map<String, String> Params, String sign, String alipayPublicKey) {
    	//过滤空值、sign与sign_type参数(比支付请求多过滤一个sign_type)
    	Map<String, String> sParaNew = AlipayCore.paraFilterForNotify(Params);
        //获取待签名字符串
        String preSignStr = AlipayCore.createLinkString(sParaNew);
        //获得签名验证结果
        boolean isSign = false;
        if(AlipayConfig.sign_type.equals("RSA")){
        	isSign = RSA.verify(preSignStr, sign, alipayPublicKey, AlipayConfig.input_charset);
        }
        return isSign;
    }
	
	private static boolean getSignVeryfys(Map<String, String> Params, String sign) {
    	//过滤空值、sign与sign_type参数(比支付请求多过滤一个sign_type)
    ...
    */
    private static String checkUrl(String urlvalue) {
        ...
        try {
        	...
        	logger.error("AlipayNotify/checkUrl --error", e);
            inputLine = "";
        }
