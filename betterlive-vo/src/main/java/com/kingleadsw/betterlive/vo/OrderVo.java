...
public class OrderVo  extends BaseVO implements Serializable{
	...
	private Integer status;          //订单状态，订单状态；0：已删除；1：待付款；2：待发货；3：已发货；4：待评价；5：已完成；6：已取消；7：已退款
   ...
   //---------------- 非原始表字段  -----------------------
	...
	private List<OrderProductVo>  listOrderProductVo;
	private Integer IsExpire=0;           //是否超过订单支付有效期     1超过有效期  0未超过   
	private String surplusTiem;          //剩余支付时间
	private String freePrice;            //订单优惠金额
	...
	public List<OrderProductVo> getListOrderProductVo() {
		return listOrderProductVo;
	}
	public void setListOrderProductVo(List<OrderProductVo> listOrderProductVo) {
		this.listOrderProductVo = listOrderProductVo;
	}
	...
	public String getSurplusTiem() {
		return surplusTiem;
	}
	public void setSurplusTiem(String surplusTiem) {
