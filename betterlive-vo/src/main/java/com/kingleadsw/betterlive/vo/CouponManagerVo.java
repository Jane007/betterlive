...
public class CouponManagerVo  extends BaseVO implements Serializable{
    /**
	 * 
	 */
	...
	private Integer coupon_type;    //优惠券类型，1：专题券，2：优惠券，3：红包
	private Integer get_source;     //获取来源，1：所有用户；2：新手券（自动发放，用户限领一份）；
