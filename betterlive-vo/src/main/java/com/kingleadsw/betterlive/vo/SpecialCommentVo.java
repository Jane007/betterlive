...
public class SpecialCommentVo  extends BaseVO implements Serializable {
	
	private static final long serialVersionUID = 3322451912026387085L;
	...
	//----------------   非原始表字段   --------------
	private CustomerVo customerVo;         //客户信息
	private String author;		//作者名字
	private String articleTitle;//标题
	private int specialTypeChild;//判断文章是精选还是动态(0.1)
	private String[] commentArrayImgs ;      //评论图片
